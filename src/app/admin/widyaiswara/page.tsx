...
// Dummy data untuk widyaiswara
const dummyWidyaiswara = [
  { id: 1, nama: "Dr. Ahmad Wijaya", nip: "198501012010011001", email: "ahmad.wijaya@kemenkeu.go.id", jenjang: "Utama", instansi: "Pusdiklat Keuangan", umur: 45, spesialisasi: "Manajemen Keuangan", phone: "081234567890" },
  { id: 2, nama: "Prof. Siti Nurhaliza", nip: "197803152005012002", email: "siti.nurhaliza@kemenkeu.go.id", jenjang: "Utama", instansi: "Pusdiklat Keuangan", umur: 52, spesialisasi: "Akuntansi Sektor Publik", phone: "081234567891" },
  { id: 3, nama: "Drs. Bambang Sutrisno", nip: "198112102008011003", email: "bambang.sutrisno@kemenkeu.go.id", jenjang: "Madya", instansi: "Pusdiklat Keuangan", umur: 42, spesialisasi: "Perpajakan", phone: "081234567892" },
  { id: 4, nama: "Dr. Rina Kartika", nip: "198505202012012004", email: "rina.kartika@kemenkeu.go.id", jenjang: "Madya", instansi: "Pusdiklat Keuangan", umur: 39, spesialisasi: "Kebijakan Fiskal", phone: "081234567893" },
  { id: 5, nama: "M.Pd. Hendra Gunawan", nip: "199002152015011005", email: "hendra.gunawan@kemenkeu.go.id", jenjang: "Muda", instansi: "Pusdiklat Keuangan", umur: 34, spesialisasi: "Teknologi Pembelajaran", phone: "081234567894" },
  { id: 6, nama: "S.Pd. Maya Sari", nip: "199208082018012006", email: "maya.sari@kemenkeu.go.id", jenjang: "Muda", instansi: "Pusdiklat Keuangan", umur: 32, spesialisasi: "Psikologi Pendidikan", phone: "081234567895" },
  { id: 7, nama: "S.E. Andi Pratama", nip: "199512252020011007", email: "andi.pratama@kemenkeu.go.id", jenjang: "Pertama", instansi: "Pusdiklat Keuangan", umur: 29, spesialisasi: "Ekonomi Pembangunan", phone: "081234567896" },
  { id: 8, nama: "S.Kom. Devi Anggraini", nip: "199607102022012008", email: "devi.anggraini@kemenkeu.go.id", jenjang: "Pertama", instansi: "Pusdiklat Keuangan", umur: 28, spesialisasi: "Sistem Informasi", phone: "081234567897" },
  { id: 9, nama: "Dr. Ir. Budi Santoso", nip: "197601012000011009", email: "budi.santoso@kemenkeu.go.id", jenjang: "Utama", instansi: "Pusdiklat Keuangan", umur: 48, spesialisasi: "Manajemen Proyek", phone: "081234567898" },
  { id: 10, nama: "M.Si. Lestari Wulandari", nip: "198304172010012010", email: "lestari.wulandari@kemenkeu.go.id", jenjang: "Madya", instansi: "Pusdiklat Keuangan", umur: 41, spesialisasi: "Statistik Ekonomi", phone: "081234567899" },
  { id: 11, nama: "S.H. Rudi Hermawan", nip: "198909202015011011", email: "rudi.hermawan@kemenkeu.go.id", jenjang: "Muda", instansi: "Pusdiklat Keuangan", umur: 35, spesialisasi: "Hukum Administrasi", phone: "081234567800" },
  { id: 12, nama: "M.Pd. Indira Sari", nip: "199103122018012012", email: "indira.sari@kemenkeu.go.id", jenjang: "Muda", instansi: "Pusdiklat Keuangan", umur: 33, spesialisasi: "Kurikulum & Instruksional", phone: "081234567801" },
  { id: 13, nama: "S.T. Fajar Nugroho", nip: "199406152021011013", email: "fajar.nugroho@kemenkeu.go.id", jenjang: "Pertama", instansi: "Pusdiklat Keuangan", umur: 30, spesialisasi: "Teknologi Informasi", phone: "081234567802" },
  { id: 14, nama: "S.Psi. Ratna Dewi", nip: "199510252022012014", email: "ratna.dewi@kemenkeu.go.id", jenjang: "Pertama", instansi: "Pusdiklat Keuangan", umur: 29, spesialisasi: "Pengembangan SDM", phone: "081234567803" },
  { id: 15, nama: "Dr. Hadi Wijaksono", nip: "197802282005011015", email: "hadi.wijaksono@kemenkeu.go.id", jenjang: "Madya", instansi: "Pusdiklat Keuangan", umur: 46, spesialisasi: "Audit Keuangan", phone: "081234567804" },
];
...
export default function WidyaiswaraPage() {
  ...
  const [widyaiswara, setWidyaiswara] = useState(dummyWidyaiswara);
  ...
  // Hitung summary dan chart dari data widyaiswara
  const jenjangList = ["Pertama", "Muda", "Madya", "Utama"];
  const jenjangData = jenjangList.map((nm) => ({
    name: nm,
    value: widyaiswara.filter((w) => w.jenjang === nm).length,
  }));
  const totalWidyaiswara = widyaiswara.length;
  ...
  const umurData = ageRanges.map((range) => ({
    name: range.range,
    value: widyaiswara.filter((w) => w.umur >= range.min && w.umur <= range.max).length,
  }));

  // Data untuk tabel
  const dataTable = widyaiswara.map((w) => ({
    id: w.id,
    nama: w.nama,
    jenjang: w.jenjang,
    instansi: w.instansi,
  ...
  const averageAge = Math.round(widyaiswara.reduce((sum, w) => sum + w.umur, 0) / widyaiswara.length);
        ...
        <div className="relative bg-white rounded-xl p-8 shadow-sm border border-gray-200 transform hover:scale-[1.01] transition-all duration-500">
          <div className="flex items-center justify-between">
            <div className="relative">
              ...
              <p className="text-gray-600 text-lg font-medium">Kelola data trainer dan pengajar dengan sistem modern</p>
            ...
            <div className="hidden md:flex items-center gap-6">
              <div className="text-right">
                <div className="text-4xl font-black text-blue-600">{totalWidyaiswara}</div>
                <div className="text-sm text-gray-600 font-medium">Total Widyaiswara</div>
                <div className="text-xs text-emerald-600 font-semibold mt-1">↗ +8% bulan ini</div>
              </div>
      ...
      >
        <div className="relative">
          ...
          <div className="relative flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg border border-gray-200 transform transition-all duration-300 group-hover:scale-105">
            ...
            <span className="hidden sm:block">Tambah Widyaiswara</span>
          </div>
          ...
          <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
            <div className="bg-gray-800/90 text-white text-xs px-3 py-2 rounded-lg shadow-lg">
              Klik untuk menambah widyaiswara baru
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-6 gap-6 mb-8">
        ...
        <div className="relative group">
          <div className="relative bg-white rounded-xl p-6 flex flex-col items-center gap-3 shadow-sm border border-gray-200 transform hover:scale-105 transition-all duration-500">
            <div className="relative">
              <FaChalkboardTeacher className="relative text-4xl text-blue-600" />
            </div>
            <div className="text-4xl font-black text-blue-600">{totalWidyaiswara}</div>
            <div className="text-gray-700 font-bold text-sm text-center">Total Widyaiswara</div>
            ...
            <div className="relative z-10">
              ...
              <div className="mt-4 text-center">
                <div className="inline-flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-full border border-emerald-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">Mayoritas widyaiswara berusia 31-45 tahun</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4 mb-8 items-center p-6 bg-gray-50 rounded-xl border border-gray-200">
              <div className="relative group">
                <input
                  type="text"
                  placeholder="🔍 Cari nama widyaiswara..."
                ...
                <tbody>
                  {pagedData.map((row, idx) => (
                    <tr 
                      ...
                      onClick={() => router.push(`/admin/widyaiswara/${row.id}`)}
                    > 
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="font-bold flex items-center gap-2">
                              {row.nama}
                              <FaChalkboardTeacher className="w-4 h-4 text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                            </div>
                            <div className="text-xs text-gray-500">ID: {row.id} • Trainer</div>
                          </div>
                        </div>
                      </td>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-lg relative border border-gray-200 transform transition-all duration-300">
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-blue-600">
                Tambah Data Widyaiswara
              </h2>
              <p className="text-gray-600 text-sm mt-2">Lengkapi form di bawah untuk menambah data widyaiswara baru</p>
            </div>
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  setWidyaiswara([...widyaiswara, newWidyaiswara]);
