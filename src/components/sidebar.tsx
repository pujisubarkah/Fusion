...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-[#1e40af] border-r border-blue-900 shadow-xl flex flex-col p-6 text-white relative overflow-hidden">
        ...
        <div>
          ...
          {open === 'ak' && (
            <div className="ml-10 mt-2 flex flex-col gap-2 text-base font-normal">
              <Link href="/user/jumlah-ak" className="px-2 py-1 rounded hover:bg-yellow-200 hover:text-blue-900 transition-colors">Jumlah AK</Link>
              <Link href="/user/analytic-ak" className="px-2 py-1 rounded hover:bg-yellow-200 hover:text-blue-900 transition-colors">Data Analytic</Link>
            </div>
          )}
        </div>
        {/* Widyaiswara */}
